...
sys.path.append("/home/liji/HIOT/MinkLoc3Dv2-main/models/ppt/")
...
print(sys.path)
from models.ppt.models.pptnet import Network
def get_parser():
    parser = argparse.ArgumentParser(description='PyTorch Point Cloud Semantic Segmentation')
    parser.add_argument('--config', type=str, required=True, help='Path to configuration file')
    parser.add_argument('--ppt_config', type=str, default='/home/liji/HIOT/MinkLoc3Dv2-main/models/ppt/configs/pptnet.yaml', help='config file')
    parser.add_argument('--model_config', type=str, required=True, help='Path to the model-specific configuration file')
    # parser.add_argument('--model_config', type=str, default='models/minkloc3dv2.txt', help='model config file')
    ...
    parser.add_argument('--eval', default=True, action='store_true', help='evaluation of the model')

    args = parser.parse_args()
    print('args.ppt_config: {}'.format(args.ppt_config))
    cfg = yaml.safe_load(open(args.ppt_config, 'r'))
...
def get_ppt_net_model():
    ...
    # Model = importlib.import_module('models.' + args["ARCH"])

    model = Network(param=args)
