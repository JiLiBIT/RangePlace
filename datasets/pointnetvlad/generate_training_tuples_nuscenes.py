...
RUNS_FOLDER = "/nuscenes/seq/"
FILENAME = "pointcloud_locations.csv"
IMAGE_FOLS = "samples/CAM_FRONT/"
RANGEIMAGE_FOLS = "/depth_map/"


def construct_query_dict(df_centroids, base_path, filename, ind_nn_r, ind_r_r=1.5):
...
if __name__ == '__main__':
    ...
    for folder in tqdm.tqdm(folders):
        ...
        df_locations['timestamp'] = RUNS_FOLDER + folder + IMAGE_FOLS + df_locations['timestamp'].astype(str) + '.png'
        df_locations = df_locations.rename(columns={'timestamp': 'file'})
        
        db_frames = {'00': range(0,12478)}
        query_frames = {'01': range(0, 6311)}
    ...
    construct_query_dict(df_train, base_path, "training_queries_nclt.pickle", ind_nn_r=1.5)
    construct_query_dict(df_test, base_path, "test_queries_nclt.pickle", ind_nn_r=1.5)
